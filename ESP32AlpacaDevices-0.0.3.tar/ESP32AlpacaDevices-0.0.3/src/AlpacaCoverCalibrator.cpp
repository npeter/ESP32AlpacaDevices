...
// init static members
const char *const AlpacaCoverCalibrator::kAlpacaCalibratorStatusStr[7] = {"NotPresent", "Off", "NotReady", "Ready", "Unknown", "Error", "Invalid"};
const char *const AlpacaCoverCalibrator::k_alpaca_cover_status_str[7] = {"NotPresent", "Off", "NotReady", "Ready", "Unknown", "Error", "Invalid"};
